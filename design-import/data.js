...
window.AppData = (() => {
  // v1.6.0: removed bear/cat categories, expanded remaining to 30-40 entries each.
  // Mirrors ios/LoverApp/Resources/Kaomoji.json — update both together.
  const KAOMOJI = {
    love: ['(♡˙︶˙♡)', '(´♡‿♡`)', '(/▽＼*)｡o○♡', '♡(>ᴗ<)♡', '(˘∇˘)♡', '(„• ֊ •„)♡', '(*˘︶˘*).｡.:*♡', '(ෆˇᴗˇෆ)', '꒰⑅•ᴗ•⑅꒱♡', '(◍•ᴗ•◍)❤', '(´｡• ᵕ •｡`) ♡', '( ˘ ³˘)♥', '(♡´︶`♡)', '(灬♥ω♥灬)', '(◕ᴗ◕✿)', '(´ε｀ )♡', '(˘▾˘~)♡', '(⺣◡⺣)♡*', '(ﾉ´ з `)ノ', '(¯`\'•.¸(♥)¸.•\'´¯)', '♡(ŐωŐ人)', '♡＾▽＾♡', '(´• ω •`) ♡', '(´。• ᵕ •。`) ♡', '( ｡ᴖ ᴖ｡)♡', '(*♡∀♡)', '♡(ӦｖӦ｡)', '(♡μ_μ)', '˖◛⁺˖°♡°˖⁺◛˖°', '♡(˃͈ દ ˂͈ ༶ )', '(´｡✪ω✪｡`)♡', '(¬‿¬ )♡', '(≧◡≦) ♡', '(.❛ ᴗ ❛.)♡', '(✿♡‿♡)', '(◍•ᴗ•◍)♡ ✧*。', '꒰♡ˊ͈ ु꒳ ूˋ͈꒱.⑅*♡', '(/ω＼*)', 'ヽ(♡‿♡)ノ', '( ´ ▽ ` ).｡ｏ♡'],
    happy: ['(◕‿◕)', '(´｡• ω •｡`)', '(≧▽≦)', '(*≧ω≦*)', '(◍•ᴗ•◍)', '(｡•̀ᴗ-)✧', '(✿◕‿◕)', '(*ˊᗜˋ*)', 'ヽ(´▽`)/', '(っ´ω`c)', '(✿◡‿◡)', '(✿´ ꒳ ` )', '(ᗒᗨᗕ)', '(◍•ᴗ•◍)✧*。', '٩(◕‿◕｡)۶', '(*˘︶˘*)', '(◠‿◠)', '(❀˘꒳˘)', 'ヽ(•‿•)ノ', '(╯✧▽✧)╯', 'ヽ(o＾▽＾o)ノ', '(*≧∇≦*)', '(￣▽￣)', '( ´ ▽ ` )ﾉ', '(o^▽^o)', '(◕‿◕｡)', '(◕ω◕)', '(•‿•)', '(✯◡✯)', '(⌒‿⌒)', '(*¯︶¯*)', '(o˘◡˘o)', 'ヽ(＾Д＾)ﾉ', '(✿◠‿◠)', '(✧ω✧)', 'ヽ(｡>▽<｡)ﾉ', '٩(♡ε♡)۶', '(◕ᗜ◕)', '(*^_^*)', '(✿ ◕‿◕)'],
    silly: ['(￣ω￣)', '(¬‿¬)', '(￣▽￣)ノ', '( ͡° ͜ʖ ͡°)', '(；￢＿￢)', '(◔_◔)', '(¬､¬)', 'ᕙ(⇀‸↼‶)ᕗ', '(눈‸눈)', '(⊙_◎)', 'ಠ╭╮ಠ', '(╯°□°）╯︵ ┻━┻', '┬─┬ノ( º_ºノ)', '( ͠° ͟ʖ ͡°)', '(ಠ_ಠ)', '(ಠ‿ಠ)', '(¬_¬")', '(눈_눈)', 'ʕ ᵒ ᴥ ᵒʔ', '(ʘᗩʘ\')', '(҂◡_◡)', '(͠≖ ͜ʖ͠≖)', '(° ͜ʖ °)', '(¬ ¬")', 'ლ(́◉◞౪◟◉‵ლ)', '(҂‾ ▵‾)', '(╬ Ò﹏Ó)', '(ↀДↀ)✧', '(¬▂¬)', '(°ヮ°)', '(°-°)', '(´∀｀)b', 'Σ( ° △ °|||)', '(ﾉಥДಥ)ﾉ', 'ヽ(`Д´)ﾉ', '(ﾟДﾟ;)', '(◣_◢)', 'ƪ(ړײ)‎ƪ'],
    sad: ['(╥﹏╥)', '(´;ω;`)', '(っ˘̩╭╮˘̩)っ', '(｡•́︿•̀｡)', '(っ- ‸ - ς)', '(´；ω；`)', '(╯︵╰,)', '(ಥ﹏ಥ)', '(；д；)', '( ；´Д｀)', '(ㄒoㄒ)', '(┳Д┳)', '(っ╥╯﹏╰╥c)', '(つ﹏<)･ﾟ｡', '(◞‸◟ㆀ)', '(╥_╥)', '(／ˍ・、)', '(個_個)', '(っ◞‸◟c)', '(；ω；)', '(˃̣̣̥᷄⌓˂̣̣̥᷅ )', '(˃̩̩̥ω˂̩̩̥)', '(｡╯︵╰｡)', '(┬┬﹏┬┬)', '(つ﹏⊂)', '(◕︵◕)', '(◞‸◟)', '(◞ﺉ◟)', '(っ´ω`c)♡', '(´°̥̥̥̥̥̥̥̥ω°̥̥̥̥̥̥̥̥｀)', '(ToT)', '(ಥ_ಥ)', '(╥ω╥)', '( つ Д ｀)', '(•̥́ ˍ •̀ू )', '(πーπ)', 'ε(´סּ︵סּ`)з'],
    surprise: ['(⊙_⊙)', '(°ロ°)', '(⊙o⊙)', '(*ﾟｪﾟ*)', '＼(º □ º l|l)/', '(゜o゜;', '(°ロ°) !', '(⊙_⊙;)', '(◎_◎;)', 'Σ(°△°|||)︴', '(@_@)', '(O_O;)', '(°o°)', 'Σ(っ °Д °;)っ', '(゜Д゜;)', 'Σ(゜ロ゜;)', '(°□°；)', '(º ロ º๑)', '(ʘ ʖ̯ ʘ)', 'ヽ(ﾟДﾟ)ﾉ', 'Σ(゚Д゚)', '(*ﾟｏﾟ*)', 'ヽ(°〇°)ﾉ', '(o_O) !', '(°ロ°)☝', '(ʘ_ʘ)', '(O.O)', '(✪㉨✪)', '(⊙ω⊙)', 'Σ(°ロ°)', '（ʘ言ʘ╬)', '(ノಠ益ಠ)ノ', '(╬ಠ益ಠ)', '(눈_눈;)', 'Σ(￣□￣;)', '(O~O)', '(°〇°)', '（o_o)'],
    sleep: ['(￣o￣) zzZ', '(-, – )…zzzZZ', '(´〜｀*) zzz', '(￣ρ￣)..zzZZ', '(￣ω￣)', '(´-ω-｀)', '(˘ω˘)', '(_ _).oO', '(´ぅω・｀)', '(✿˘ω˘)', '(´〜｀)', '(￣o￣) . z Z', '(¦3[▓▓]', '(´~`)ゞ', '(￣ヘ￣)zZ', '(o´ω`o)ﾉ Zzz', '( ⌣́_⌣̀)', '(˘･_･˘)', '(￢_￢)', 'Σ(￣。￣ﾉ)Zzz', '(っ˘ω˘ς )', '(´ぅω-`)', '(- ω -) zzZ', '(˘▾˘)', '(˘‿˘)', '(˘ω˘ ) zzz', '(⊃｡•́‿•̀｡)⊃', '( ´△｀) zzz', '(￣Ω￣;)', '(´ω｀*)', '(˘ˇ˘).｡oZ', '(￣ー￣)', '(´-ω-｀)zzZ', '(¦3ꇤ[▓▓]', '(˙ω˙ )zzz', '(￣～￣;)', '(˘ω˘) zZ', '(￣o￣)..zzZ', '(´〜｀*)', '(っ-‸ς)'],
    food: ['(っ˘ڡ˘ς)', '(*¯︶¯*)', '|･ω･`)○ ⊃─', '~(￣▽￣)~*', '(っ˘ڡ˘ς)♡', '(◍ ´ ꒳ ` ◍)', '(ㆁωㆁ*)', '(´﹃｀)', '(っ´ω`)っ', '( ˘ω˘ )⊃', '(¯﹃¯)', 'ლ(´ڡ`ლ)', '(っ˘ڡ˘)っ', '(*´ڡ`●)', '(っ´ｰ`)っ', '( ﾟдﾟ)つ Ⅱ', '(っ＾▿＾)っ', '(づ｡◕‿‿◕｡)づ', '(つ✧ω✧)つ', '(◕ㅂ◕)', '(￣﹃￣)', '(ᗒᗨᗕ)', '(◍•ᴗ•◍)♪', '(っ´▽`)っ', 'ヽ(´｡• ω •｡`)ﾉ', '( ◜‿◝ )♡', '(◕‿◕)/', '(*°ｪ°*)', 'ヽ(* ´ ∀ ` *)ﾉ', '( ´ ▽ ` )ﾉ', '(◍•ᴗ•◍)❤', '( ˘ω˘ )', '(っ◔◡◔)っ', '(ↁ_ↁ)', '( ´◔ ‸◔`)', '(´◔౪◔)', '( ◜◡◝ )', 'ヾ(´︶`*)ﾉ♬', '(*ﾟ▽ﾟ*)'],
    dance: ['ヽ(•‿•)ノ', '٩(◕‿◕)۶', '＼(^o^)／', 'ヽ(´∇`)ﾉ', '٩(｡•́‿•̀｡)۶', 'ヽ(´▽`)ノ', '♪(┌・。・)┌', 'ヾ(⌐■_■)ノ♪', 'ヽ(*・ω・)ﾉ', '～(\'▽^人)', 'ヾ(´︶`*)ﾉ♬', '♪~ ᕕ(ᐛ)ᕗ', 'ヽ(o＾▽＾o)ノ', 'ヾ(*´∀`*)ﾉ', 'ヽ(>∀<☆)ノ', 'ᕕ( ᐛ )ᕗ', 'ヽ(゜∇゜)ノ', 'ヽ(´ー｀)ノ', '(/^▽^)/', '＼(٥⁀▽⁀)／', '♪(^∇^*)', 'ヾ(＠゜▽゜＠)ノ', 'ヽ(✿ﾟ▽ﾟ)ノ', '(/◕ヮ◕)/', 'ヾ(•ω•`)o', 'ヽ(°◇° )ノ', '(╯✧▽✧)╯', 'ヾ(⌒(ﾉ\'ヮ\'ﾉ)', 'ヾ(◍\'౪`◍)ﾉﾞ', 'ヽ(゚∀゚)ﾒ(ﾟ∀ﾟ)ﾒ(ﾟ∀ﾟ)ﾉ', 'ヾ(´〇`)ﾉ', 'ヽ(o^▽^o)ノ', '♪♪ ヽ(ˇ∀ˇ )ゞ', '(((❛︵❛.)))', 'ヾ(*ﾟｰﾟ)ﾂ', '(ノ^o^)ノ', '(ノ´ヮ´)ノ*:･ﾟ✧', 'ヾ(❀ฺ´∀`❀ฺ)ﾉ', 'ヽ(⌐■_■)ノ♪♬', '└(^o^ )X( ^o^)┘'],
  };
